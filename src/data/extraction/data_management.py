...
class DataManager:
    """
    Object that helps to interact with a PostgresSQL database
    """
        ...
        for col in cols:
            ...
            if group is not None:
                for group_val in group_values:
                    ...
                    # We append the statistics for subgroup participants to the results dictionary
...
class PetaleDataManager(DataManager):
    ...
    def get_table_stats(self,
        ...
        # We get the dataframe containing the table
        ...
        # We merge the categorical dataframe with the sex dataframe by the column PARTICIPANT
        ...
        # We merge the numerical dataframe with the sex dataframe by the column PARTICIPANT
    ...
    def pivot_snp_dataframe(df: pd.DataFrame,
        ...
        if snps_id_filter is not None:
            df = df[df[PetaleDataManager.KEY].isin(snps_id_filter[PetaleDataManager.KEY].to_list())]
